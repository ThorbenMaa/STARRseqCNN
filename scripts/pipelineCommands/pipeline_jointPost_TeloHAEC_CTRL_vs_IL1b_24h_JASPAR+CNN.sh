...
setUpComp="noInDels_diffTeloHEAC_CTRL_vs_24h_jointPos"
setUpOne="TeloHAEC_CTRL"
setUpTwo="TeloHAEC_IL1b_24h"
motifSource="multitaskCNN_v2_JASPAR"
...
cp JASPAR2022_CORE_vertebrates_non-redundant_pfms_meme_nice.txt ./results/${setUpComp}_${motifSource}/${motifSource}_PWMs.txt \

tail -n +10 ./results/${setUpComp}_${motifSource}/${motifSource}_PWMs.txt >>./results/${setUpComp}_${motifSource}/${setUpComp}_PWMs.txt 
