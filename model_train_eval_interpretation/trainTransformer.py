...
def cli(activity_file, seq_file, augmentation, learning_rates, epochs, sequence_length, batch_size, n_tasks, model_name, hold_out_chr, earlyStop):
    ...
    for lr in learning_rates:
        ...
        #training transformer model (https://github.com/jeffheaton/t81_558_deep_learning/blob/master/t81_558_class_10_5_keras_transformers.ipynb)
        loss= keras.losses.MeanSquaredError()
        optim = tf.keras.optimizers.Adam(learning_rate=lr)
        metrics=["mse", "mae", "mape", "acc"]
        print("compile model")
...
def transformer_encoder(inputs, head_size, num_heads, ff_dim, dropout=0):
    ...
    x = keras.layers.MultiHeadAttention(                             ###### num heads sind parallele attention layers, wie parrallele filter. wie verschiedene leute mit vercsh meinung zu einem thema und die meinungen werden dann zu einer integriert spaeter
